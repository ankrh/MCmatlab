...
Ginput.assumeMatchedInterfaces = true; % Assumes all refractive indices are 1
...
Ginput.GeomFunc = @GeometryDefinition_ImagingExample; % Function to use for defining the distribution of media in the cuboid. Defined at the end of this m file.
