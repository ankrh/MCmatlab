...
%   
%   Simulates both absorption of energy and diffusion of heat through the
%   tissue.
%
...
%   the simulation and plotted/recorded. The more such updates, the slower
%   the simulation will be.
%
%   Input
%       name
%           the basename of the file generated by runMonteCarlo.m
%
%   Displays
%       Tissue cube
%       Temperature evolution during illumination and diffusion (voxels)
%       Temperature evolution for the individual temperature sensors (x-y-plot)
%       Temperature distributions after illumination and after diffusion
%
%   Output
%       temperatureSensor
...
%           file containing temperature after illumination and after
%           diffusion (voxels)
%
%   Requires
%       calcdtmax.m
