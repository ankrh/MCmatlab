...
model.MC.LS.FPID.radialWidth = .02; % [cm] Radial focal plane 1/e^2 radius if top-hat or Gaussian or half-width of the full distribution if custom
...
model.MC.LS.zFocus       = model.G.Lz/2; % [cm] z position of focus
