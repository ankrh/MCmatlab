...
model.MC.LS.AID.radialWidth = 10/180*pi; % [rad] Radial angular 1/e^2 half-angle if top-hat or Gaussian or half-angle of the full distribution if custom. For a diffraction limited Gaussian beam, this should be set to model.MC.wavelength*1e-9/(pi*model.MC.LS.FPID.radialWidth*1e-2))
model.MC.LS.xFocus       = 0; % [cm] x position of focus
model.MC.LS.yFocus       = -0.017; % [cm] y position of focus
model.MC.LS.zFocus       = 0.078; % [cm] z position of focus
