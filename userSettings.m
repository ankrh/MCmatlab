...
nm_min = 845; %Minimum wavelength of the filter. No lower than 300+dnm [nm];
nm_max = 855; %Maximum wavelength of the filter. No higher than 1000-dnm [nm];
...
save([directoryPath 'Input spectrum'])
