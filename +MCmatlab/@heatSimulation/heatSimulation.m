classdef heatSimulation
    ...
    properties
        ...
        durationOn                              % [s] Pulse on-duration
        durationOff                             % [s] Pulse off-duration
        durationEnd                             % [s] Non-illuminated relaxation time to add to the end of the simulation to let temperature diffuse after the pulse train
        Tinitial                                % [deg C] Initial temperature, can be scalar or 3D array
        
        nPulses                                 % Number of consecutive pulses, each with an illumination phase and a diffusion phase. If simulating only illumination or only diffusion, use n_pulses = 1.
        
        plotTempLimits                          % [deg C] Expected range of temperatures, used only for setting the color scale in the plot
